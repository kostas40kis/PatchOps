# L25.40 Microsoft Edge controlled runtime real-download artifact manifest validation final acceptance marker

L25.40 follows accepted L25.39 and marks the real-download-artifact manifest-validation ladder complete.

Accepted ladder finalized by L25.40:
...
- L25.39 accepted the broad checkpoint over that validation and proved the source-payload-only boundary stayed closed.

Allowed in L25.40:

- require the explicit L25.40 final-acceptance token;
- verify the accepted L25.39 broad-checkpoint source payload;
- mark the manifest-validation ladder as final accepted;
...
- confirm artifact/ZIP open, extraction, execution, run-package, browser, pasteback, localhost, extension, commit, and push are still closed.
...
Next patch: L25.41 Microsoft Edge controlled runtime real-download artifact package-execution authorization gate.
