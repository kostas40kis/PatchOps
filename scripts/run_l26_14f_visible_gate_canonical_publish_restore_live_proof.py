...
from patchops.edge_rpa.edge_l26_14f_visible_gate_canonical_publish_restore import assert_acceptance, run_visible_gate_canonical_publish_restore
...
def main() -> int:
    ...
    a = p.parse_args()
    result = run_visible_gate_canonical_publish_restore(
    ...
    print("L26_14F_VISIBLE_GATE_CANONICAL_PUBLISH_RESTORE_JSON_START")
    print(json.dumps(result.to_payload(), indent=2, sort_keys=True))
    print("L26_14F_VISIBLE_GATE_CANONICAL_PUBLISH_RESTORE_JSON_END")
    assert_acceptance(result)
    print("L26_14F_ACCEPTANCE: PASS")
