...
from patchops.edge_rpa.edge_l26_12x_generated_artifact_candidate_diff_filter import assert_acceptance, run_generated_candidate_diff_filter
...
def main() -> int:
    ...
    a = p.parse_args()
    result = run_generated_candidate_diff_filter(
    ...
    print("L26_12X_GENERATED_ARTIFACT_CANDIDATE_DIFF_FILTER_JSON_START")
    print(json.dumps(result.to_payload(), indent=2, sort_keys=True))
    print("L26_12X_GENERATED_ARTIFACT_CANDIDATE_DIFF_FILTER_JSON_END")
    assert_acceptance(result)
    print("L26_12X_ACCEPTANCE: PASS")
    print("generated_candidate_click_allowed:false")
