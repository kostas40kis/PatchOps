...
from patchops.edge_rpa.edge_l26_14d_visible_attachment_upload_gate_repair import assert_acceptance, run_visible_attachment_upload_gate_repair
...
def main() -> int:
    ...
    a = p.parse_args()
    result = run_visible_attachment_upload_gate_repair(
        ...
        a.stability_delay_seconds, a.attachment_verify_seconds,
    )
    print("L26_14D_VISIBLE_ATTACHMENT_UPLOAD_GATE_REPAIR_JSON_START")
    print(json.dumps(result.to_payload(), indent=2, sort_keys=True))
    print("L26_14D_VISIBLE_ATTACHMENT_UPLOAD_GATE_REPAIR_JSON_END")
    assert_acceptance(result)
    print("L26_14D_ACCEPTANCE: PASS")
