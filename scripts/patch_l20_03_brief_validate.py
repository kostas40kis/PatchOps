...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Brief L20.3 validation")
    ...
    summary = {
        ...
        "source_l20_2_cli_readback_checkpoint_accepted": payload.get("source_l20_2_cli_readback_checkpoint_accepted"),
        "l20_2_complete": payload.get("l20_2_complete"),
        "l20_1_passive_preflight_gate_accepted": payload.get("l20_1_passive_preflight_gate_accepted"),
        "filesystem_validation_candidate_definition_blocks_l20_3_filesystem_file_read_archive_package_run": payload.get("filesystem_validation_candidate_definition_blocks_l20_3_filesystem_file_read_archive_package_run"),
        "future_filesystem_validation_plan_is_planned_not_executed": payload.get("future_filesystem_validation_plan_is_planned_not_executed"),
        "future_filesystem_validation_plan_blocks_filesystem_file_read_archive_package_run": payload.get("future_filesystem_validation_plan_blocks_filesystem_file_read_archive_package_run"),
