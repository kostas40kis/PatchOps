...
DEFAULT_SELF_REPORT_PATH = Path("data/runtime/copilot_handoff/pseudo_self_report_slash_enter_enter_upload_no_send_self_report.txt")
...
def write_self_report(path: Path) -> str:
    ...
    lines = [
        ...
        "purpose: pseudo patch generated self-report for Chrome slash-picker attach no-send smoke",
        ...
        "expected_result_label: PASS_CHROME_SELF_REPORT_SLASH_ENTER_ENTER_ATTACHED_NO_SEND",
        ...
        "note: This file is selected through native file picker using slash command trigger, exact path write, and Open button click. The smoke stops before Send.",
        "",
    ]
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="PatchOps apply smoke: slash-picker attach self-report in Chrome without Send")
    ...
    parser.add_argument("--confirm-live-browser-text", default=CONFIRM_CHROME_SLASH_ENTER_ENTER_SELF_REPORT_UPLOAD_NO_SEND)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    return 0 if result.result_label == PASS_CHROME_SELF_REPORT_SLASH_ENTER_ENTER_ATTACHED_NO_SEND else 2
