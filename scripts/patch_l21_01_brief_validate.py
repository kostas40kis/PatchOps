...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Brief L21.1 validation")
    ...
    authorized_payload = l21_01.build_edge_downloaded_archive_validation_passive_preflight_gate(
        ...
        authorization_token=l21_01.REQUIRED_ARCHIVE_PREFLIGHT_AUTHORIZATION_TOKEN,
        target_url=args.target_url,
    )
    ok = (
    ...
    summary = {
        ...
        "source_l20_7_final_marker_accepted": authorized_payload.get("source_l20_7_final_marker_accepted"),
        "l20_downloaded_file_filesystem_validation_stream_complete": authorized_payload.get("l20_downloaded_file_filesystem_validation_stream_complete"),
        "l20_completion_means_synthetic_fixture_existence_only_validation": authorized_payload.get("l20_completion_means_synthetic_fixture_existence_only_validation"),
        ...
        "archive_validation_preflight_authorization_is_readback_only_in_l21_1": authorized_payload.get("archive_validation_preflight_authorization_is_readback_only_in_l21_1"),
