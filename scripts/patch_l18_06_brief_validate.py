...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Brief L18.6 validation")
    ...
    summary = {
        ...
        "l18_1_through_l18_5_remain_accepted": payload.get("l18_1_through_l18_5_remain_accepted"),
        "metadata_only_download_readiness_proof_remains_accepted": payload.get("metadata_only_download_readiness_proof_remains_accepted"),
        "source_l18_5_default_readback_ok": payload.get("source_l18_5_default_readback_ok"),
        "source_l18_5_authorized_positive_readback_ok": payload.get("source_l18_5_authorized_positive_readback_ok"),
        "download_metadata_classification_validated": payload.get("download_metadata_classification_validated"),
        "download_metadata_scope": payload.get("download_metadata_scope"),
