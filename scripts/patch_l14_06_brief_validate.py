...
def main() -> int:
    ...
    commands = [
        [sys.executable, "-m", "compileall", "patchops/llm_browser", "tests/test_l14_05_edge_dedicated_profile_lifecycle_cli_readback_current.py", "tests/test_l14_06_edge_dedicated_profile_lifecycle_aggregate_gate_current.py", "scripts/patch_l14_06_brief_validate.py"],
    ...
    ok = ok and payload.get("patch") == "L14.6"
    ok = ok and payload.get("profile_aggregate_truthful") is True
    ok = ok and payload.get("profile_aggregate_gate_is_passive") is True
    ...
    summary = {
        ...
        "profile_aggregate_truthful": payload.get("profile_aggregate_truthful"),
        "profile_aggregate_passive": payload.get("profile_aggregate_gate_is_passive"),
