...
def main() -> int:
    ...
    commands = [
        [sys.executable, "-m", "compileall", "patchops/llm_browser", "tests/test_l14_04_edge_dedicated_profile_lifecycle_preflight_current.py", "tests/test_l14_05_edge_dedicated_profile_lifecycle_cli_readback_current.py", "scripts/patch_l14_05_brief_validate.py"],
    ...
    ok = ok and payload.get("patch") == "L14.5"
    ok = ok and payload.get("profile_readback_truthful") is True
    ok = ok and payload.get("profile_lifecycle_cli_readback_is_passive") is True
    ...
    summary = {
        ...
        "profile_readback_truthful": payload.get("profile_readback_truthful"),
        "profile_cli_readback_passive": payload.get("profile_lifecycle_cli_readback_is_passive"),
