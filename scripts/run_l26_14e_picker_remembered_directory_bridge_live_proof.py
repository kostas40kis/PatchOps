...
from patchops.edge_rpa.edge_l26_14e_picker_remembered_directory_bridge import assert_acceptance, run_picker_remembered_directory_bridge
...
def main() -> int:
    ...
    a = p.parse_args()
    result = run_picker_remembered_directory_bridge(
        ...
        a.observe_seconds, a.probe_seconds, a.stability_delay_seconds, a.attachment_verify_seconds,
    )
    print("L26_14E_PICKER_REMEMBERED_DIRECTORY_BRIDGE_JSON_START")
    print(json.dumps(result.to_payload(), indent=2, sort_keys=True))
    print("L26_14E_PICKER_REMEMBERED_DIRECTORY_BRIDGE_JSON_END")
    assert_acceptance(result)
    print("L26_14E_ACCEPTANCE: PASS")
    print("visible_attachment_gate_passed:true")
    print("uploaded_safe_copy_parent_matches_bridge:true")
    return 0
