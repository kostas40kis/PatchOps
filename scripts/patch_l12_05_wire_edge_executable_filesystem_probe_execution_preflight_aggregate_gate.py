...
MODULE_PATH = Path("patchops/llm_browser/live_adapter_edge_executable_filesystem_probe_execution_preflight_aggregate_gate.py")
DOC_PATH = Path("docs/llm_browser_live_adapter_edge_executable_filesystem_probe_execution_preflight_aggregate_gate.md")
TEST_PATH = Path("tests/test_l12_05_edge_executable_filesystem_probe_execution_preflight_aggregate_gate_current.py")
VALIDATE_PATH = Path("scripts/patch_l12_05_brief_validate.py")
COMMANDS_PATH = Path("patchops/llm_browser/commands.py")

MODULE_CONTENT = r'''"""L12.5 passive Microsoft Edge executable filesystem-probe execution preflight aggregate gate.

Aggregates the accepted L12.1 through L12.4 execution-preflight stack. Execution
preflight readiness may become true when all required gates are present, but
...
from patchops.llm_browser import live_adapter_edge_executable_filesystem_probe_execution_preflight_fixture_matrix_cli_readback as l12_04

PATCH = "L12.5"
PHASE = "L12"
STATUS_PASS = "PASS"
STATUS_FAIL = "FAIL"
NAME = "L12.5 Microsoft Edge Executable Filesystem Probe Execution Preflight Aggregate Gate"
COMMAND_NAME = "browser-start-supervised-launch-edge-executable-filesystem-probe-execution-preflight-aggregate-gate"
SOURCE_COMMAND_NAME = "browser-start-supervised-launch-edge-executable-filesystem-probe-execution-preflight-fixture-matrix-readback"
NEXT_PATCH = "L12.6 Live adapter Microsoft Edge executable filesystem probe execution preflight aggregate gate CLI/readback"
SIDE_EFFECT_BOUNDARY = "edge-executable-filesystem-probe-execution-preflight-aggregate-gate-only"
...
def _source_l12_04_safe(source: Mapping[str, Any], *, expected_real_ready: bool, expected_execution_ready: bool) -> bool:
    fixture_ids = set(source.get("execution_preflight_fixture_ids", []))
    return (
        source.get("patch") == "L12.4"
...
def _aggregate_state(source: Mapping[str, Any]) -> dict[str, Any]:
    chain_acceptance = {
        "l12_01": source.get("edge_executable_filesystem_probe_execution_preflight_contract_enforced") is True,
        "l12_02": source.get("edge_executable_filesystem_probe_execution_preflight_cli_readback_enforced") is True,
        "l12_03": source.get("edge_executable_filesystem_probe_execution_preflight_fixture_matrix_enforced") is True,
        "l12_04": source.get("ok") is True and source.get("status") == STATUS_PASS,
    }
    return {
        "edge_executable_filesystem_probe_execution_preflight_aggregate_gate_enforced": True,
        "execution_preflight_aggregate_status": "MODELED_ONLY_BLOCKED_BY_PHASE",
        "execution_preflight_aggregate_reason": "L12.5 aggregates L12.1-L12.4 while real filesystem probing remains reserved for a later accepted phase.",
        "l12_01_execution_preflight_contract_ok": chain_acceptance["l12_01"],
        "l12_02_execution_preflight_cli_readback_ok": chain_acceptance["l12_02"],
        "l12_03_execution_preflight_fixture_matrix_ok": chain_acceptance["l12_03"],
        "l12_04_execution_preflight_fixture_matrix_cli_readback_ok": chain_acceptance["l12_04"],
        "chain_acceptance": chain_acceptance,
        "fixture_count": source.get("execution_preflight_fixture_count"),
        "fixture_ids": source.get("execution_preflight_fixture_ids"),
...
def build_edge_executable_filesystem_probe_execution_preflight_aggregate_gate(
    ...
    *,
    ...
    source = l12_04.build_edge_executable_filesystem_probe_execution_preflight_fixture_matrix_cli_readback(
        root,
    ...
    source_safe = _source_l12_04_safe(source, expected_real_ready=expected_real_ready, expected_execution_ready=expected_execution_ready)
    ...
    checks = [
        _check("l12_04_execution_preflight_fixture_matrix_readback_still_passes", source_safe, _compact_source_status(source)),
        _check("l12_04_execution_preflight_fixture_matrix_readback_remains_passive", source_safe, {"exec_ready": source.get("execution_preflight_ready"), "exec_allowed": source.get("execution_preflight_execution_allowed"), "fs_probe": source.get("edge_executable_filesystem_probe_performed")}),
        _check("l12_01_through_l12_04_chain_remains_accepted", chain_ok, aggregate["chain_acceptance"]),
        _check("l12_05_execution_preflight_aggregate_gate_command_registered", command_state.get("ok") is True, command_state),
        _check("l12_04_source_command_still_registered", source_command_state.get("ok") is True, source_command_state),
        _check("edge_l12_required_source_docs_tests_present", not missing_paths, {"missing": missing_paths}),
        _check("edge_l12_docs_contain_execution_preflight_aggregate_gate_boundary", doc_state.get("ok") is True, doc_state),
        _check("execution_preflight_aggregate_gate_is_enforced", aggregate["edge_executable_filesystem_probe_execution_preflight_aggregate_gate_enforced"] is True, aggregate),
        ...
        _check("execution_preflight_execution_remains_blocked_by_phase", source.get("execution_preflight_execution_allowed") is False and aggregate["execution_preflight_execution_allowed"] is False, {}),
    ...
    return {
        ...
        "l12_01_execution_preflight_contract_remains_accepted": aggregate["l12_01_execution_preflight_contract_ok"],
        "l12_02_execution_preflight_cli_readback_remains_accepted": aggregate["l12_02_execution_preflight_cli_readback_ok"],
        "l12_03_execution_preflight_fixture_matrix_remains_accepted": aggregate["l12_03_execution_preflight_fixture_matrix_ok"],
        "l12_04_execution_preflight_fixture_matrix_cli_readback_remains_accepted": aggregate["l12_04_execution_preflight_fixture_matrix_cli_readback_ok"],
        "source_l12_04_status": _compact_source_status(source),
        "edge_executable_filesystem_probe_execution_preflight_aggregate": aggregate,
        "edge_executable_filesystem_probe_execution_preflight_aggregate_gate_enforced": aggregate["edge_executable_filesystem_probe_execution_preflight_aggregate_gate_enforced"],
        "execution_preflight_aggregate_status": aggregate["execution_preflight_aggregate_status"],
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    payload = build_edge_executable_filesystem_probe_execution_preflight_aggregate_gate(
        args.repo_root,
...
DOC_CONTENT = r'''# L12.5 Microsoft Edge executable filesystem probe execution preflight aggregate gate
...
SOURCE_COMMAND = "browser-start-supervised-launch-edge-executable-filesystem-probe-execution-preflight-fixture-matrix-readback"
DEDICATED_PROFILE = PROJECT_ROOT / "data" / "runtime" / "browser_profiles" / "edge_l12_05_candidate"
...
def _assert_passive(payload: dict) -> None:
    ...
    assert "source_l12_05_summary" not in payload
    assert "source_l12_04_summary" not in payload


def test_l12_05_command_is_registered() -> None:
    from patchops.llm_browser import commands
...
def test_l12_05_aggregate_not_ready_without_all_required_gates() -> None:
    for kwargs in [
        ...
        payload = aggregate.build_edge_executable_filesystem_probe_execution_preflight_aggregate_gate(PROJECT_ROOT, **kwargs)
        assert payload["ok"] is True
        assert payload["patch"] == "L12.5"
...
def test_l12_05_execution_preflight_ready_but_execution_still_blocked() -> None:
    ...
    assert payload["execution_preflight_execution_allowed"] is False
    assert payload["edge_executable_filesystem_probe_performed"] is False
    assert payload["next_patch"] == "L12.6 Live adapter Microsoft Edge executable filesystem probe execution preflight aggregate gate CLI/readback"
    _assert_passive(payload)


def test_l12_05_default_and_missing_profile_cases_are_passive_when_execution_preflight_ready() -> None:
    default_payload = aggregate.build_edge_executable_filesystem_probe_execution_preflight_aggregate_gate(PROJECT_ROOT, allow_live_start=True, profile_dir=DEFAULT_PROFILE, allow_executable_probe=True, activate_executable_filesystem_probe=True, allow_real_filesystem_probe=True, allow_executable_filesystem_probe_execution=True)
    missing_payload = aggregate.build_edge_executable_filesystem_probe_execution_preflight_aggregate_gate(PROJECT_ROOT, allow_live_start=True, profile_dir=None, allow_executable_probe=True, activate_executable_filesystem_probe=True, allow_real_filesystem_probe=True, allow_executable_filesystem_probe_execution=True)
    assert default_payload["ok"] is True
    assert default_payload["source_l12_04_status"]["ok"] is True
    assert default_payload["execution_preflight_ready"] is True
    _assert_passive(default_payload)
    assert missing_payload["ok"] is True
    assert missing_payload["source_l12_04_status"]["ok"] is True
    assert missing_payload["execution_preflight_ready"] is True
    _assert_passive(missing_payload)


def test_l12_05_patchops_cli_json_readback_is_parseable_compact_and_passive() -> None:
...
def test_l12_05_doc_mentions_execution_preflight_aggregate_boundaries() -> None:
    doc = PROJECT_ROOT / "docs" / "llm_browser_live_adapter_edge_executable_filesystem_probe_execution_preflight_aggregate_gate.md"
...
def _append_command_block() -> None:
    ...
    if "# PATCHOPS L12.5 START" not in text:
        if not text.endswith("\n"):
            text += "\n"
        COMMANDS_PATH.write_text(text + "\n" + COMMAND_BLOCK.strip() + "\n", encoding="utf-8")
        print("L12.5 command wrapper appended")
    else:
        print("L12.5 command wrapper already present")


def _append_l12_04_doc_pointer() -> None:
    path = Path("docs/llm_browser_live_adapter_edge_executable_filesystem_probe_execution_preflight_fixture_matrix_cli_readback.md")
    if not path.exists():
        return
    text = path.read_text(encoding="utf-8")
    phrase = "L12.5 Live adapter Microsoft Edge executable filesystem probe execution preflight aggregate gate"
    if phrase not in text:
        path.write_text(text.rstrip() + "\n\nNext accepted frontier after the execution preflight fixture matrix CLI/readback:\n\n`" + phrase + "`\n", encoding="utf-8")
        print("L12.4 doc next-frontier pointer appended")
...
def main() -> int:
    ...
    _append_l12_04_doc_pointer()
    print("L12.5 files written; validation is intentionally brief and compact")
    return 0
