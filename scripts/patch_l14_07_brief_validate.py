...
def main() -> int:
    ...
    commands = [
        [sys.executable, "-m", "compileall", "patchops/llm_browser", "tests/test_l14_06_edge_dedicated_profile_lifecycle_aggregate_gate_current.py", "tests/test_l14_07_edge_dedicated_profile_lifecycle_aggregate_gate_cli_readback_current.py", "scripts/patch_l14_07_brief_validate.py"],
    ...
    ok = ok and payload.get("patch") == "L14.7"
    ok = ok and payload.get("profile_aggregate_cli_readback_truthful") is True
    ok = ok and payload.get("profile_aggregate_cli_readback_is_passive") is True
    ...
    ok = ok and payload.get("adapter_filesystem_writes_performed") == []
    ...
    summary = {
        ...
        "profile_aggregate_cli_readback_truthful": payload.get("profile_aggregate_cli_readback_truthful"),
        "profile_aggregate_cli_readback_passive": payload.get("profile_aggregate_cli_readback_is_passive"),
