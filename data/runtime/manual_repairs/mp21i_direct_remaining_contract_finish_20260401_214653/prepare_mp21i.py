...
PATCH_NAME = "mp21i_direct_remaining_contract_finish"
...
def main() -> int:
    ...
    audit = {
        ...
        "latest_attempted_patch": latest_index.get("latest_attempted_patch"),
        "next_prompt_mentions_primary_contract_phrase": "compatibility fallback rather than the primary contract" in next_prompt_text,
        "writers_has_normalized_content_source": "normalized_content_source" in writers_text,
        "metadata_uses_compare_false_fields": "compare=False" in metadata_text,
