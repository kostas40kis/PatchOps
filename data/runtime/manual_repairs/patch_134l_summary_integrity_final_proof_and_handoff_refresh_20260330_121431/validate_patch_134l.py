...
if (
    "patch_134k_report_dir_proof_layer_repair" not in latest_report_copy
    and "patch_134l_summary_integrity_final_proof_and_handoff_refresh" not in latest_report_copy
):
    raise SystemExit(
        "handoff/latest_report_copy.txt did not mention the current green report from Patch 134K or Patch 134L."
    )
