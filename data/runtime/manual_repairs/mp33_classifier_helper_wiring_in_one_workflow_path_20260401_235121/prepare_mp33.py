...
def main() -> int:
    ...
    apply_def_present = "def apply_patch(" in source
    ...
    if helper_import_present and helper_def_present and helper_call_present and current_test_exists:
        write_state(
            prep_state_path,
            {
                ...
                "apply_def_present": "yes" if apply_def_present else "no",
    ...
    if not apply_def_present or not failure_assignment_present:
        write_state(
            prep_state_path,
            {
                "decision": "stop_unexpected_apply_shape",
                "decision_reason": "apply_patch.py no longer contains the expected apply_patch function or failure assignment anchor.",
                "apply_path_exists": "yes",
                "categories_exists": "yes",
                "rules_test_exists": "yes",
                "legacy_test_exists": "yes" if legacy_test_exists else "no",
