...
## Final release / maintenance gate status

This block records the maintained F6 gate posture without reopening the architecture.
...
REQUIRED_GATE_PATHS = (
    ...
    "powershell/Invoke-PatchPlan.ps1",
...
manifest = {
    ...
    "validation_commands": [
        ...
        },
        {
            ...
            "program": python_exe,
            "args": ["-m", "patchops.cli", "release-readiness", "--wrapper-root", ".", "--core-tests-green"],
            "working_directory": ".",
            "use_profile_runtime": False,
            "allowed_exit_codes": [0],
        },
