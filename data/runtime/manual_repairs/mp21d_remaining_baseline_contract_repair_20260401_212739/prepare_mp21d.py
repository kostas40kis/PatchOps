...
PATCH_NAME = "mp21d_remaining_baseline_contract_repair"
...
def main() -> int:
    ...
    for relative_path, text in targets.items():
        write_text(content_root / relative_path, text)
    ...
    audit = {
        ...
        "staged_files": [str((content_root / path).resolve()) for path in targets.keys()],
    }
    ...
    manifest = {
        ...
        "backup_files": list(targets.keys()),
        "files_to_write": [
            {
                "path": relative_path,
                "content": text,
        ...
        "report_preferences": {
            ...
            "report_name_prefix": "mp21d",
            "write_to_desktop": False,
        },
        "tags": ["pythonization", "baseline_repair", "mp21d", "self_hosted"],
        "notes": "Repair the remaining baseline contracts after MP21C boot restore.",
    }
