...
def main() -> int:
    if len(sys.argv) != 3:
        print("usage: prepare_mp15g.py <wrapper_root> <working_root>", file=sys.stderr)
        return 2
...
"""
    ...
    manifest = {
        "manifest_version": "1",
        "patch_name": "mp15g_report_helper_manifest_newline_fix",
        ...
        "report_preferences": {
            ...
            "report_name_prefix": "mp15g_report_helper_manifest_newline_fix",
    ...
    prep_lines = [
        "decision=mp15g_report_helper_manifest_newline_fix",
