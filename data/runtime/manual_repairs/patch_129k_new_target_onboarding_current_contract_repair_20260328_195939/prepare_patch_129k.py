...
"""
    ...
    # Critical fix: PatchOps resolves relative content_path from manifest_path.parent,
    # so this must be relative to the temp manifest directory, not repo_root.
    manifest_relative_content_path = content_path.relative_to(work_root)
        ...
        "files_to_write": [
            {
                ...
                "content": None,
                "content_path": manifest_relative_content_path.as_posix(),
                "encoding": "utf-8"
            }
        ],
        "validation_commands": [
    ...
    print(json.dumps({
        ...
        "manifest_relative_content_path": manifest_relative_content_path.as_posix(),
