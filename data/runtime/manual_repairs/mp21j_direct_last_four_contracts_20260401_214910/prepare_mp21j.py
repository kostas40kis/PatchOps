...
PATCH_NAME = "mp21j_direct_last_four_contracts"
...
def main() -> int:
    ...
    latest_index["next_recommended_mode"] = "repair_patch"
    ...
    audit = {
        ...
        "latest_index_has_next_recommended_mode": isinstance(latest_index.get("next_recommended_mode"), str),
        "next_prompt_has_do_not_reopen_sentence": "Do not reopen this area unless new contrary repo evidence appears." in next_prompt_text,
        "writers_has_inline_content": "inline_content" in writers_text,
        "metadata_compare_false_fields": "compare=False" in metadata_text,
