...
if new_block not in common_text:
    if old_block not in common_text:
        raise SystemExit("Could not find current compact build_report_path block to replace.")
...
manifest = {
    "manifest_version": "1",
    "patch_name": "p134t_report_dir_fallback_fix",
    "active_profile": "generic_python",
    ...
    "report_preferences": {
        ...
        "report_name_prefix": "p134t",
        "write_to_desktop": False,
    },
    "tags": ["self_hosted", "summary_integrity", "report_dir", "fallback_fix"],
    "notes": "Patch 134T adds a short deterministic fallback report directory for Windows-hostile long custom report_dir shapes.",
}
