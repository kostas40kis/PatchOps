...
MARKER = "PATCHOPS_MP46_ARTIFACT_REPORT_MENTION"
TEST_MARKER = "PATCHOPS_MP46_ARTIFACT_REPORT_MENTION_TEST"
...
REPORT_MARKER = "PATCHOPS_MP46_ARTIFACT_REPORT_MENTION"
...
MARKER = "PATCHOPS_MP46_ARTIFACT_REPORT_MENTION_TEST"
...
def main() -> int:
    ...
    if module_path.exists() and test_path.exists():
        ...
        already_present = REPORT_MARKER in module_text and TEST_MARKER in test_text
