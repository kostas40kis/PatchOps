...
manifest = {
    "manifest_version": "1",
    "patch_name": "p134w_report_dir_fallback_exact_current",
    "active_profile": "generic_python",
    ...
    "validation_commands": [
        {
            "name": "report_path_fallback_exact_current_pytest",
            "program": "py",
            "args": [
                "-m",
                "pytest",
    ...
    "notes": "Patch 134W preserves the exact-current preferred/compact/minimal path sequence and adds fallback only after the current minimal path is still over budget.",
}
