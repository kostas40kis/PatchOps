...
def plan_manifest(
    ...
    if mode != "verify":
        backup_root_pattern = target_root / resolved_profile.backup_root_name / f"{safe_patch}_<timestamp>"
    ...
    return {
        ...
        "target_files": [str(target_root / item.path) for item in manifest.files_to_write],
