...
The content-path example is now covered by a dedicated apply-flow test, so future LLMs can treat it as a proven end-to-end authoring pattern instead of an inspect-only example.
