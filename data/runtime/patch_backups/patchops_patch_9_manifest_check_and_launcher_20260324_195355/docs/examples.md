...
4. `py -m patchops.cli inspect .\data\runtime\generated_templates\generic_verify_template.json`
5. `py -m patchops.cli plan .\examples\generic_backup_patch.json`
6. `py -m patchops.cli apply .\examples\generic_python_patch.json`
7. `py -m patchops.cli apply .\examples\generic_backup_patch.json`
8. `py -m patchops.cli verify .\examples\generic_verify_patch.json`
