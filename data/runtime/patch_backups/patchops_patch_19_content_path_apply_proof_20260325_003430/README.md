...
The allowed-exit example is useful when a command is expected to return a non-zero code that should still be treated as acceptable evidence for that step.
