...
## Trader first-usage starter examples

- `examples/trader_first_doc_patch.json`
  - A low-risk trader documentation patch starter.
  - Intended for the first real trader-facing PatchOps apply flow.

- `examples/trader_first_verify_patch.json`
  - A low-risk trader verification-only starter.
  - Intended for the first real trader-facing PatchOps verify flow.

These starters are not meant to replace the trader-specific examples already in the repo.
They exist to reduce ambiguity around the *first* deliberate trader-facing PatchOps run.
