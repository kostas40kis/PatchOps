"""L20.3 passive plan checkpoint for downloaded-file filesystem validation.

This module defines the future real-filesystem validation plan after the accepted
L20.2 CLI/readback checkpoint. It is deliberately passive: no Edge start, no page
inspection, no click, no download, no real file existence check, no stat, no
hash, no archive open/list/extract, no manifest read, no file-byte read, no
artifact-content read, no paste, no send, no package run, no localhost service,
no browser extension, no commit, and no push.
"""
...
STATUS_PASS = "PASS"
STATUS_FAIL = "FAIL"
NAME = "L20.3 Microsoft Edge downloaded-file filesystem validation passive plan checkpoint"
COMMAND_NAME = "browser-start-supervised-launch-edge-downloaded-file-filesystem-validation-passive-plan-checkpoint"
SOURCE_COMMAND_NAME = "browser-start-supervised-launch-edge-downloaded-file-filesystem-validation-cli-readback-checkpoint"
SOURCE_PATCH = "L20.2"
NEXT_PATCH = "L20.4 Microsoft Edge downloaded-file filesystem validation controlled authorization gate"
...
def _missing_doc_phrases(root: Path) -> list[str]:
    text = _read_text(root / "docs/llm_browser_live_adapter_edge_downloaded_file_filesystem_validation_passive_plan_checkpoint.md")
...
def filesystem_validation_candidate_definition() -> dict[str, Any]:
    return {
        "definition_version": "1",
        "candidate_means": "metadata-only path evidence for a future downloaded PatchOps zip artifact on disk",
        ...
        "future_candidate_path_rules": {
            ...
            "path_must_be_metadata_only_in_l20_3": True,
            "path_must_not_be_default_edge_profile": True,
            "reject_non_zip": True,
            "reject_ambiguous_multiple_candidates": True,
        },
        "future_validation_stages": {
            "existence_check_allowed_in_l20_3": False,
            "stat_allowed_in_l20_3": False,
            "hash_allowed_in_l20_3": False,
            "archive_open_allowed_in_l20_3": False,
            "archive_listing_allowed_in_l20_3": False,
            "archive_extract_allowed_in_l20_3": False,
            "manifest_read_allowed_in_l20_3": False,
            "file_byte_read_allowed_in_l20_3": False,
            "package_run_allowed_in_l20_3": False,
        },
...
def future_filesystem_validation_plan() -> list[dict[str, Any]]:
    return [
        {
            "step": 1,
            "name": "confirm_l20_2_cli_readback_checkpoint_accepted",
            "status": "planned_not_executed",
            "side_effect": False,
        },
        {
            "step": 2,
            "name": "require_l20_4_or_later_explicit_filesystem_validation_authorization_token",
            "status": "planned_not_executed",
            "side_effect": False,
        },
        {
        ...
        },
        {
            ...
            "status": "planned_not_executed",
            "allowed_only_in_future_l20_4_or_later": True,
            "side_effect": True,
            "file_exists_check_allowed_in_l20_3": False,
            "read_file_bytes": False,
        },
        {
            "step": 5,
            "name": "future_phase_may_stat_file_metadata_without_opening_archive",
            "status": "planned_not_executed",
            "allowed_only_in_future_l20_4_or_later": True,
            "side_effect": True,
            "file_stat_allowed_in_l20_3": False,
            "archive_open": False,
            "manifest_read": False,
        },
        {
            "step": 6,
            "name": "future_hash_requires_separate_gate_because_hash_reads_bytes",
            "status": "planned_not_executed",
            "allowed_only_in_later_stream": True,
            "side_effect": True,
            "file_hash_allowed_in_l20_3": False,
            "file_byte_read_allowed_in_l20_3": False,
        },
        {
            "step": 7,
            ...
            "allowed_only_in_later_stream": True,
            "side_effect": False,
            "archive_open_in_l20_3": False,
            "archive_listing_in_l20_3": False,
            "archive_extract_in_l20_3": False,
            "manifest_read_in_l20_3": False,
            "package_run_in_l20_3": False,
        },
        {
            "step": 8,
            "name": "l20_3_plan_checkpoint_does_not_execute_filesystem_validation",
            "status": "planned_not_executed",
            "side_effect": False,
...
def _plan_blocks_filesystem_file_read_archive_package_run(plan: Sequence[Mapping[str, Any]]) -> bool:
    ...
    final = plan[-1]
    return (
        future_exists.get("file_exists_check_allowed_in_l20_3") is False
        and future_exists.get("read_file_bytes") is False
        and future_stat.get("file_stat_allowed_in_l20_3") is False
        and future_stat.get("archive_open") is False
        and future_stat.get("manifest_read") is False
        and future_hash.get("file_hash_allowed_in_l20_3") is False
        and future_hash.get("file_byte_read_allowed_in_l20_3") is False
        and archive.get("archive_open_in_l20_3") is False
        and archive.get("archive_listing_in_l20_3") is False
        and archive.get("archive_extract_in_l20_3") is False
        and archive.get("manifest_read_in_l20_3") is False
        and archive.get("package_run_in_l20_3") is False
...
def build_edge_downloaded_file_filesystem_validation_passive_plan_checkpoint(
    repo_root: str | Path | None = None,
    *,
    target_url: str | None = None,
) -> dict[str, Any]:
    """Build the L20.3 passive filesystem-validation plan checkpoint payload."""
    root = _repo_root(repo_root)
    before_modules = set(sys.modules)
    target = target_url or DEFAULT_TARGET_URL
    source = l20_02.build_edge_downloaded_file_filesystem_validation_cli_readback_checkpoint(root, target_url=target)
    ...
    definition = filesystem_validation_candidate_definition()
    plan = future_filesystem_validation_plan()
    target_url_allowed = bool(source.get("target_url_allowed"))

    source_ok = (
        source.get("ok") is True
        and source.get("patch") == SOURCE_PATCH
        and source.get("l20_2_complete") is True
        and source.get("l20_1_passive_preflight_gate_accepted") is True
        and source.get("l20_1_default_compact_readback_ok") is True
        and source.get("l20_1_authorized_compact_readback_ok") is True
        and source.get("filesystem_validation_preflight_authorization_remains_readback_only") is True
    ...
    definition_blocks = (
        definition["future_validation_stages"]["existence_check_allowed_in_l20_3"] is False
        and definition["future_validation_stages"]["stat_allowed_in_l20_3"] is False
        and definition["future_validation_stages"]["hash_allowed_in_l20_3"] is False
        and definition["future_validation_stages"]["archive_open_allowed_in_l20_3"] is False
        and definition["future_validation_stages"]["archive_listing_allowed_in_l20_3"] is False
        and definition["future_validation_stages"]["archive_extract_allowed_in_l20_3"] is False
        and definition["future_validation_stages"]["manifest_read_allowed_in_l20_3"] is False
        and definition["future_validation_stages"]["file_byte_read_allowed_in_l20_3"] is False
        and definition["future_validation_stages"]["package_run_allowed_in_l20_3"] is False
    )
    ...
    checks = [
        _check("source_l20_2_cli_readback_checkpoint_accepted", source_ok),
        ...
        _check("filesystem_validation_candidate_definition_blocks_l20_3_filesystem_file_read_archive_package_run", definition_blocks),
        _check("future_filesystem_validation_plan_is_planned_not_executed", plan_is_planned_not_executed),
        _check("future_filesystem_validation_plan_blocks_filesystem_file_read_archive_package_run", plan_blocks),
        _check("filesystem_validation_execution_still_blocked", True),
        _check("filesystem_byte_hash_archive_manifest_still_blocked", True),
        ...
        _check("docs_contain_l20_3_safety_contract", not missing_doc_phrases, {"missing_phrases": missing_doc_phrases}),
    ...
    return {
        ...
        "filesystem_validation_passive_plan_checkpoint": True,
        "microsoft_edge_first": True,
        "opera_second": True,
        "opera_active_implementation_target": False,
        "source_l20_2_cli_readback_checkpoint_accepted": source_ok,
        "l20_2_complete": bool(source.get("l20_2_complete")),
        "l20_1_passive_preflight_gate_accepted": bool(source.get("l20_1_passive_preflight_gate_accepted")),
        "filesystem_validation_candidate_definition": definition,
        "filesystem_validation_candidate_definition_blocks_l20_3_filesystem_file_read_archive_package_run": definition_blocks,
        "future_filesystem_validation_plan": plan,
        "future_filesystem_validation_plan_is_planned_not_executed": plan_is_planned_not_executed,
        "future_filesystem_validation_plan_blocks_filesystem_file_read_archive_package_run": plan_blocks,
        "filesystem_validation_execution_allowed": False,
        ...
        "source_l20_2_summary": {
            "ok": source.get("ok"),
            "patch": source.get("patch"),
            "l20_2_complete": source.get("l20_2_complete"),
            "l20_1_passive_preflight_gate_accepted": source.get("l20_1_passive_preflight_gate_accepted"),
            "l20_1_default_compact_readback_ok": source.get("l20_1_default_compact_readback_ok"),
            "l20_1_authorized_compact_readback_ok": source.get("l20_1_authorized_compact_readback_ok"),
        ...
        "l20_3_complete": ok,
        "remaining_l20_3_patches": [] if ok else [PATCH],
...
def render_text(payload: Mapping[str, Any]) -> str:
    lines = [
        ...
        f"L20.2 Accepted                  : {payload.get('source_l20_2_cli_readback_checkpoint_accepted')}",
        f"Plan Blocks Filesystem Reads    : {payload.get('future_filesystem_validation_plan_blocks_filesystem_file_read_archive_package_run')}",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    payload = build_edge_downloaded_file_filesystem_validation_passive_plan_checkpoint(args.repo_root, target_url=args.target_url)
    if args.json:
