...
def test_u2_1qi_success_payload_has_legacy_contract_fields(tmp_path: Path) -> None:
    ...
    assert payload["launch_policy_reason"] == "operator_set_mode_is_focus_only"


def test_u2_1qi_missing_config_payload_has_legacy_contract_fields(tmp_path: Path) -> None:
