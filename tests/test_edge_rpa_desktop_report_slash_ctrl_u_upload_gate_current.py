...
from patchops.edge_rpa.edge_desktop_report_slash_ctrl_u_upload_gate import DesktopReportSlashCtrlUUploadResult, assert_l26_12j_acceptance


def test_acceptance_passes_desktop_report_slash_ctrl_u_result() -> None:
    result = DesktopReportSlashCtrlUUploadResult(
...
def test_acceptance_rejects_plus_button_after_slash() -> None:
    result = DesktopReportSlashCtrlUUploadResult(
        target_chat_accepted_without_navigation=True,
        navigation_attempted=False,
        report_path_exists=True,
        ...
        composer_cleared_before_slash=True,
        slash_typed_in_composer=True,
        plus_button_clicked_after_slash=True,
        ctrl_u_shortcut_sent=True,
        picker_window_detected=True,
        picker_window_kind="#32770",
        picker_navigation_attempted=True,
    ...
    try:
        ...
        assert "plus_button_clicked_after_slash" in str(exc)
    else:
        raise AssertionError("plus-after-slash double menu must fail L26.12J acceptance")
