...
def test_wrapper_only_repair_constant_is_stable():
    assert WRAPPER_ONLY_REPAIR == 'wrapper_only_repair'


def test_wrapper_only_repair_recommended_for_wrapper_failure_when_content_already_present_and_no_writes():
...
def test_wrapper_only_repair_not_recommended_when_writes_were_applied_by_wrapper():
    assert should_recommend_wrapper_only_repair(
        failure_class=WRAPPER_FAILURE,
        target_content_already_present=True,
...
def test_wrapper_only_repair_not_recommended_for_non_wrapper_failure():
    assert should_recommend_wrapper_only_repair(
...
def test_wrapper_only_repair_not_recommended_when_target_content_not_already_present():
    assert should_recommend_wrapper_only_repair(
        failure_class=WRAPPER_FAILURE,
...
def test_verify_only_helper_still_does_not_claim_wrapper_failure():
